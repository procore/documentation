...
Any app that calls the Procore API declares Data Connector components and uses the grants below, whatever else it does. An embedded app that needs Procore data does exactly this.
