...
- You must use Procore's REST APIs for their intended transactional purpose — creating, reading, updating, and deleting records as part of your app's core integration. See the [API Usage Guidelines]({{ site.url }}{{ site.baseurl }}{% link platform_concepts/api_usage_guidelines.md %}) for details.
