...
<div class="step-item">
  <div class="step-icon">
    <div class="step-icon-inner">
      <img src="{{ '/assets/guides/create-app.svg' | relative_url }}" alt="Partner Application icon" />
    </div>
  </div>
...
<div class="step-item">
  <div class="step-icon">
    <div class="step-icon-inner">
      <img src="{{ '/assets/guides/prepare-listing.svg' | relative_url }}" alt="Technical Feasibility icon" />
    </div>
  </div>
  <div class="step-content">
...
<div class="step-item">
  <div class="step-icon">
    <div class="step-icon-inner">
      <img src="{{ '/assets/guides/create-app.svg' | relative_url }}" alt="Build Test and Certify icon" />
    </div>
  </div>
  <div class="step-content">
...
<div class="step-item">
  <div class="step-icon">
    <div class="step-icon-inner">
      <img src="{{ '/assets/guides/market-app.svg' | relative_url }}" alt="Launch and Go to Market icon" />
    </div>
  </div>
  <div class="step-content">
...
<div class="cta-container">
  <a href="https://docs.google.com/forms/d/e/1FAIpQLSfygvXmaQPUsc0800Sb8XylMJqaq1kax2fzyrcfYCO2NvQKvg/viewform" class="create-account-button" target="_blank">
