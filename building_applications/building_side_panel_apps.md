...
| /:project_id/project/prime_contracts/:id/change_orders/potential_change_orders/edit: | prime_contracts.change_orders.potential_change_orders.detail |
...
| URL Path | View Key |
| -------- | -------- |
| /:project_id/project/budgeting: | budgeting.list |
| /:project_id/project/budgets/budget_details: | budgeting.detail |
| /:project_id/project/forecasting: | budgeting.forecasting.detail |
